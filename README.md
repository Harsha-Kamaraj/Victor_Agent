...
**Status: all eight phases complete.** 785 tests, and `victor doctor` reports what is genuinely unavailable on your machine rather than a green tick for something that does not work.
